...
class AppTheme {
  static const Color cBg = Color(0xFF0F0F12);
  static const Color cSurface = Color(0xFF18181F);
  static const Color cEdge = Color(0xFF252533);
  static const Color cAccent = Color(0xFFE11D48);
  static const Color cAccent2 = Color(0xFFFB7185);
  static const Color cInk = Color(0xFFFFF1F2);
